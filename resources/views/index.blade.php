        ...
        <div id="mainMenuContainer" class="main-menu-container full-height w0 fixed">
            <nav id="main-menu" role="navigation">
                ...
                <ul class="menu">
                    ...
                    <li class="distributor-investor-menu display-none"><a href="{{url('updates.html')}}">Updates</a></li>
                    <li class="distributor-investor-menu display-none"><a href="{{url('picture-gallery.html')}}">Picture Gallery</a></li>
                    <li class="distributor-investor-menu display-none"><a href="{{url('future-ideas.html')}}">Future Ideas</a></li>
                    <li class="distributor-investor-menu display-none"><a href="{{url('financial-updates.html')}}">Financial Updates</a></li>
                    ...
                    <div class="company-info align-center full-height">
                        <div class="menu-dropdown-overlay">
                            <ul>
                                ...
                                <li><a href="{{url('account/add-user.html')}}">Add User</a></li>
                                <li class="md-divider"></li>
                                <li class="logout-menu display-none"><a href="{{url('logout.html')}}">Log out</a></li>
                            </ul>
                        </div>
                        <div class="text-right">
                            <h3>Company Name</h3>
        ...
        <div id="placeholder1"></div>
            <div id="headerSvg" class="_50-width z-index-2 absolute top-left">
                ...
                <div class="absolute top-left _85-width _85-height align-in-center">
                    <a href="" class="full-width align-in-center"><img class="_40-width _mb_40 mr-80 sm_mb-20 mr-5" src="images/logo.png"></a>
                </div>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-5 18 977.35 707.88">
                    ...
                    <g id="Group_93" data-name="Group 93" transform="translate(-66.324 12)">
                        ...
                        <g id="Group_4" data-name="Group 4" class="cls-2" transform="translate(388.344)">
                            ...
                            <image id="Layer_1" data-name="Layer 1" width="1060.232" height="757.165" xlink:href="images/header2-image.jpg"/>
                            </g>
                        </g>
                        </g>
        ...
        <footer class="full-width z-index-5 relative">
            ...
            <svg style="margin-bottom: -10px;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 761.705 463.652">
                ...
                <g id="fpIUa2.tif" transform="translate(58.997 3380.907)">
                    <image id="Layer_1" data-name="Layer 1" width="81.663" height="76.145" xlink:href="images/logo.png"/>
                </g>
