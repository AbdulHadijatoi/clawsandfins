            ...
            <div class="content">
                <div class="full-width align-in-center pb-120">
                    <div class="_75-width flex-column z-index-1 justify-center sm_90-width sm_align-center mt-180 sm_mt-10">
                        ...
                        <h1 class="h1 text-yellow 
                    sm_font-size-25 text-white sm_text-center sm_full-width _55-width">Ecological production</h1>
                        <p class="para text-white sm_font-size-11 sm_text-center sm_full-width _55-width">
                            All our seafood is ecologically produced. Our endeavor is not using resources from wildlife. We are only using farm-raised animals for our production. Our production is free from using harmful chemicals that can contaminate the environment or the food products we produce. Instead, we use natural minerals and bacteria to break down our waste products into harmless, biodegradable compounds.
                        </p>
                        <div class="full-width justify-between align-center sm_flex-column sm_justify-center">
                            ...
                            <div class="flex-column _50-width sm_text-center sm_90-width">
                                <p class="para text-white sm_font-size-11" id="hermetia-illucens">
                                    We recycle all organic waste we produce, also, we obtain organic waste from other farms, restaurants, and food markets. The organic waste we collect allows a particular larva from the <em
                                        class="text-yellow"><a class="popup-page-url" parent-id="hermetia-illucens" href="{{url('popup/hermetia-illucens')}}">Hermetia illucens</a></em> species, known commonly as black soldier fly larva (BSFL), to feeds on it and grow fatter. When the larva has developed to a pupa, it is cleaned, cooked and grided to a paste used as a high-quality protein and lipids perfectly suited as ecological animal feed, reducing the need for wild-sourced feed ingredients such as fishmeal which contributes to the global overfishing.
                                </p>
                            </div>
                        </div>
                    </div>
