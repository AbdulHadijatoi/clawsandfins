                    ...
                    <div class="_75-width md_90-width md_align-center flex-column justify-center max-w700">
                        <div class="full-width">
                            <div class="text-center">
                                <h1 class="h1 text-yellow sm_font-size-35 sm_mt-60 text-center">Add new role</h1>
                                <span class="h4 text-white text-center mb-30">Add new role and assign permissions.</span>
                            </div>
