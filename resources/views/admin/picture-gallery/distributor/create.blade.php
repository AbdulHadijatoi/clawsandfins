                    ...
                    <div class="_75-width md_90-width md_align-center flex-column justify-center max-w700">
                        <div class="full-width">
                            <div class="text-center">
                                ...
                                <span class="h4 text-white text-center mb-30">Upload new pictures to distributor gallery.</span>
                            </div>
                            <div class="form-container align-center justify-center flex-column">
                                <div class="container mt-4">
                                    ...
                                    <form method="POST" action="{{ route('distributor-picture-gallery.store') }}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="justify-center align-center">
                                            ...
                                            <div class="justify-center align-center">
                                                ...
                                                <a href="{{ route('distributor-picture-gallery.index') }}" class="btn btn-default">Back</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
