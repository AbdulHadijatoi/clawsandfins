                    ...
                    <div class="_75-width md_90-width md_align-center flex-column justify-center max-w700">
                        <div class="full-width">
                            <div class="text-center">
                                <h1 class="h1 text-yellow sm_font-size-35 sm_mt-60 text-center">Distributor Picture Gallery</h1>
                                <span class="h4 text-white text-center mb-30">Manage picture gallery for distributor.</span>
                                <div class="justify-center">
                                    <div class="button-primary">
                                        <a href="{{ route('distributor-picture-gallery.create') }}"><button>Add picture</button></a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="d-flex flex-wrap justify-center">
                                    ...
                                    <div class="thumbnail-preview">
                                        ...
                                        <div class="btn-delete">
                                            {!! Form::open(['method' => 'DELETE','route' => ['distributor-picture-gallery.destroy',
