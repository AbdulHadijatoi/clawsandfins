                        ...
                        <div class="_75-width md_90-width flex-column justify-center max-w700">
                            ...
                            <div class="text-white font-size-12 p-10 mb-20">
                                ...
                                <p class="para sm_font-size-11 mt-20 mb-20 expandable-content" id="long-introduction">
                                    ...
                                    <strong>Earlier boxes</strong> - As some of you might remember, I had a crab-box offering earlier, just before Covid struck us. All boxes got booked in a matter of days and a reserve list had to be created as well. But Covid made it impossible to continue the project, so I had to withdraw the offer and no money ever changed hands. <br><br>
                                    <strong>New boxes</strong> - Now, Covid is more or less over, and the project has been back on track for a while and now ready for a new crab-box offering. This time it will come with a better income profile where the box-income will increasingly benefit from the project's growth, instead of being a fixed percentage as before.<br><br>
                                ...
                                <a href="{{url('/boxpromo/offerings')}}" class="text-yellow text-center mb-20 expand-link" data-target="short-introduction" style="width: 100% !important; display: block; font-size: 1.2rem;">
                                    <strong><u>Click to see offerings</u></strong><br>
