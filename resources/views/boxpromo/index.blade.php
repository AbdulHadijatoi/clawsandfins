                           ...
                           <br>
                            ...
                            <div class="text-white font-size-12 p-10 mb-20">
                                 ...
                                 <p class="para sm_font-size-11 mt-20 mb-20">
                                    <strong>Please read everything, and follow the link at the end of each page to the next one. Additional information can be found in the menu on the left.   
                                    </strong><br><br>
                                    ...
                                    <br>
                                    As many of you already know, I have been working on a large AI-driven high-tech soft-shell crab project for a while. Now after almost 7 years and 40-50,000 hours of project development, testing, prototyping, researching, designing, etc, etc, the project is reaching a final phase, and we have started to build our first full sized, but shorter machine (15m), which will be extended later (120m). And I need your help to speed things up. 
                                    <br><br>
                                    Take a look at the project’s <a class="text-yellow" href="{{url('timeline/')}}">7-year long timeline with MANY photos.</a> 
                                    <br>
                                ...
                                <a href="{{url('/boxpromo/offerings')}}" class="text-yellow text-center mb-20" style="width: 100% !important; display: block; font-size: 1.2rem;">
                                    <strong><u>Get your own boxes</u></strong><br>
