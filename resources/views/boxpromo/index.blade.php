                        ...
                        <div class="_75-width md_90-width flex-column justify-center max-w700">
                            ...
                            <div class="text-white font-size-12 p-10 mb-20">
                                ...
                                <a class="text-yellow text-center mt-40 mb-20 expand-link" data-target="long-introduction" style="width: 100% !important; display: block; font-size: 1.2rem;">
                                    ...
                                    <span class="text-blue font-size-12 expand-indicator">(Click to expand down)</span>
                                </a>
                                ...
                                <a class="text-yellow text-center mt-40 mb-20 expand-link" data-target="time_plan" style="width: 100% !important; display: block; font-size: 1.2rem;">
                                    <strong>Time Plan</strong> <br>
                                    <span class="text-blue font-size-12 expand-indicator">(Click to expand down)</span>
                                </a>

                                <p class="para sm_font-size-11 mt-20 mb-20 expandable-content" id="time_plan">
                    ...
                    expandLinks.forEach(function (otherLink) {
                        if (otherLink !== link) {
                            ...
                            if (otherTargetContent) {
                                ...
                                otherLink.querySelector(".expand-indicator").classList.remove("hidden");
                            }
                        }
                    });

                    targetContent.classList.toggle("expanded");
                    link.querySelector(".expand-indicator").classList.add("hidden");
                }
            });
        });
    });
