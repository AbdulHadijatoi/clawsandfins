                    ...
                    <div class="full-width align-in-center pb-60">
                        <div class="_75-width md_90-width flex-column justify-center max-w700">
                            ...
                            <div class="text-default font-size-12 p-10 mb-20">
                                <p class="text-default text-center" style="width: 100% !important; display: block;">
                                ...
                                <a class="text-default text-center mt-40 mb-20 expand-link" data-target="long-introduction" style="width: 100% !important; display: block; font-size: 1.2rem;">
                                ...
                                <a class="text-default text-center mt-40 mb-20 expand-link" data-target="time_plan" style="width: 100% !important; display: block; font-size: 1.2rem;">
                                    <strong>Time Plan</strong> 
                                    <span class="text-blue">(Click to expand down)</span>
                                </a>

                                <p class="para sm_font-size-11 text-default mt-20 mb-20 expandable-content" id="time_plan">
