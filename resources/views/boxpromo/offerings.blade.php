                            ...
                            <div class="text-white font-size-12 p-10 mb-20">
                                ...
                                <p class="para sm_font-size-11 mt-20 mb-20 expandable-content" id="offerings">
                                    ...
                                    <ul style="display: block; list-style: disc" class="para sm_font-size-11 mt-20 mb-20 ml-20">
                                        <li>
                                            <strong class="text-yellow">$8 box with $1.2 return - Early adopters, Available now, pay only 33% ($1334 per bundle)</strong><br></a>
                                        ...
                                        <br>
                                        <li>
                                            <strong class="text-yellow">$12 box with $1.2 return - For more careful adopters. Available quarter 3, 2024 but can be booked now (10% deposit)</strong><br>
