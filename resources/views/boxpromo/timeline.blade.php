                    ...
                    <div class="full-width align-in-center pb-60">
                        <div class="_75-width md_90-width flex-column justify-center max-w700">
                            ...
                            <div class="text-white font-size-12 p-10 mb-20">
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2017 - Soft-shell crab fraud</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2017 July - Moved to Vietnam</h3>
                                <p class="para sm_font-size-11">My soft-shell crab research led me to Vietnam. I left Thailand, as Vietnam has one of the best Scylla crabs in the world, and Thailand mostly import their Scylla crabs from Laos and Vietnam, so it was not optimal for obvious reasons to continue my work in Thailand.</p>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2018 Jan - Assistant, Ms.Van</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2018 - Early 3D printing</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2018 - Our laboratory</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2018 - 2019 - Live crabs</h3>
                                <p class="para sm_font-size-11">Research, laboratory tests with live crabs, experimenting with different box designs, different box colors, different light inlets, different feeds, different water compositions.</p>
                                <div><img src="{{asset('timeline_images/image113.jpg')}}"></div>
                                <div><img src="{{asset('timeline_images/image115.jpg')}}"></div>
                                <p class="para sm_font-size-11">Our “test bench“ for the next coming year with room for 120 crabs with 30 different light conditions.</p> 
                                ...
                                <p class="para sm_font-size-11">An early stage in our RAS water treatment system, in which we learned a lot about minerals, water chemistry, and bacteriology.</p>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2019 - Lab testing finalized</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2019 - More 3D printed parts for testing</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2019 - Factory Design</h3>
                                ...
                                <p class="para sm_font-size-11">Factory building where the roof has ben removed to be able to see the production line and water treatment.</p>
                                ...
                                <p class="para sm_font-size-11">The only stage that requires personnel is loading and unloading the boxes with crabs onto a conveyor belt. The conveyor belt then leads to shuttles that pick up the boxes and deliver them to the automated production line.</p>

                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2019 - Plant site survey</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2019 - We got invited</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2020 - Final design ready</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2020 - Electronics development</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2020 - 2021 - Covid halted everything</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2021 April - photo shot session</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2021 - Company mascot</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2021-2022 - Website developed</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2022 - Explainer video graphics</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2022 - Video production</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2022 - Financial model and budget</h3>
                                <p class="para sm_font-size-11">Financial model and budget finalized. </p>

                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2022 - Investor promotion videos</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2022 - Hard-to-get parts</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2022 - Custom made self-clinching nuts arrived</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2022 - Inspection unit</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2022 - Updated electronics</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2022 - Mid-chassis prototype</h3>
                                ...
                                <p class="para sm_font-size-11">&nbsp; A Section of the mid-chassis. </p>

                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2022 Dec - Light tent</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2022 Dec - AI vision testing rig</h3>
                                ...
                                <p class="para sm_font-size-11">Test rig for Inspection and AI tests. </p>

                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2022 Dec - 2023 May - Endurance testing</h3>
                                <p class="para sm_font-size-11">Long term endurance testing of different CNC parts, 3D printed parts, 3D resins, model servos, geared motors etc, etc. Some tests lasted for 6 month which equals to 10-210 years of production, yea 210+ years :-D depending which test though. All these testing to ensure that all equipment and components will last.</p>
                                <div><img src="{{asset('timeline_images/image71.png')}}"></div>
                                <p class="para sm_font-size-11">Different machine assemblies in a longevity test with different loads. Not pretty but very efficient. </p>

                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2022 - More 3 </h3>

                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2023 - Corrosion testing</h3>
                                ...
                                <p class="para sm_font-size-11">Parts tested in saltwater spray for a while. The right hand stainless 304 screw will not last long. But the left hand anodized Alu6061 will. </p>

                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2023 13th Jan - AI vision works</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2023 21 st &nbsp;Feb - Our first customer</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2023 - Testing of large water valves</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2023 - Autonomous shuttle electronics</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2023 - Machines and equipment</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2023 - Aluminum profiles arrived</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2023 - Aluminum sheets arrived</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2023 - Faster inspector electronics</h3>
                                <p class="para sm_font-size-11">A faster inspector AI microprocessor was decided to be used, and a higher resolution image sensor, so a new revision of the inspector electronics began development as added speed might help to increase production capacity a bit as we have been able to speed up other steps in the process as well.</p>
                                ...
                                <p class="para sm_font-size-11">Inspector machine vision PCBs a </p>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2023 Sept - Robot and shuttle &nbsp;parts delivered</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2023 Sept - Robot and shuttle &nbsp;assembling</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2023 Sept - Shuttle electronics in testing</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2023 Sept - New inspecton PCB ready</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2023 Sept - Design of robots drive electronics</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2023 Sept - Custom made close loop servos arrived</h3>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2023 Oct - Welding chassis sections and jigs</h3>
                                <p class="para sm_font-size-11">We began to test build and weld the chassis sections. And tested our welding jigs as well </p>
                                ...
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">2023 Oct - First pillar leg</h3>
                                ...
                                <p class="para sm_font-size-11"><span class="text-bold">2023 Nov</span> - More information will be added as we progresses</p>
                                <h3 class="text-yellow mt-20 font-size-25 sm_font-size-18 text-center mb-10">Tasks left to do</h3>
                                ...
                                <p class="para sm_font-size-11"><span class="text-bold">2025 Q1</span> - First production line runs at full production </p>
                                <p class="para sm_font-size-11"><span class="text-bold">2025 Q3</span> The second line will be up and running in full production.</p>
