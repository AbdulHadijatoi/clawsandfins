                            ...
                            <div class="text-white font-size-12 p-10 mb-20">
                                ...
                                <a class="text-yellow text-center mb-20" style="width: 100% !important; display: block; font-size: 1.2rem;">
                                 ...
                                 <p class="para sm_font-size-11 text-center mt-20 mb-20">
                                    <strong>This is a simple summary, so please read everything, and follow the link at the end of each page. Additional information can be found in the menu on the left.  
                                    </strong></p>
                               
                                
                                <p class="para sm_font-size-11 mt-20 mb-20">
                                 <strong class="text-yellow"></strong> 
                                    <strong class="text-yellow">Get a box</strong> - Köp en krabbox för $8 och betala bara 1/3 nu, och resten i 2 omgångar, med 3 månaders mellanrum, vilket ger dig en chans att se våra framsteg. (För företag kan vi utfärda fakturor). 
                                    <br><br>
                                    
                                    <strong class="text-yellow">Get free boxes</strong> - The box above will earn you an additional free box for every new machine I get up in production. So, 2 machines in production = you will have the box you bought plus one free box, and with 10 machines = you will have the box you bought plus nine free boxes. 
                                    <br><br>
                                    ...
                                    <br><br>
                                     ...
                                     <strong class="text-yellow">Bundles</strong> -  Boxes will come in bundles of 500 boxes in each. The reason for these bundles is to minimize future administrative workload. If you wish to buy fewer boxes, see if you can partner with some friends, or contact me and I will see if I can partner you with someone in the same situation. 
                                    <br><br>
                                    
                                     <strong class="text-yellow">Availability</strong> -  I only have 33 bundles available, and no new ones will be offered with this arrangement. Book by sending me Peter a message on FB messenger.
                                    <br><br>
                                    
                                    <strong class="text-yellow">Your first payment</strong> - I will need an estimated 1.5 year to finalize the first machine and production before you can expect to get your first payment of 15%.
                                    <br><br>
