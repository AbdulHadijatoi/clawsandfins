            ...
            <div class="content">
                <div class="full-width align-in-center pb-60">
                    <div class="_75-width md_90-width flex-column justify-center max-w700">
                        <h1 class="h1 text-default sm_font-size-35 text-center mb-10">Supply & Auction</h1>
                        <div class="text-default font-size-12 p-10 mb-20">
                            <p class="para sm_font-size-11 text-default mt-20 mb-20">
                                Later, we will be presenting our daily available stocks of various seafood products and run daily auctions for you distributors to bid on.
                            </p>
                        </div>
                    </div>
                </div>
