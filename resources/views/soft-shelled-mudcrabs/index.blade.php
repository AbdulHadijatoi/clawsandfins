...
<body>
    <div class="body-content max-w1280 margin-auto overflow-hidden">
            ...
            <nav id="main-menu" role="navigation">
                ...
                <ul>
                    <ul class="menu">
                        ...
                        <li class="active"><a href="">Soft-shelled mudcrabs</a></li>
                        <li class="sub-menu display-block">
                            <ul>
                                <li id="frozen-whole"><a class="popup-page-url" parent-id="frozen-whole"
                                        href="../../pages/soft-shelled-mudcrabs/pages/frozen-whole.html #content">Frozen - Whole</a>
                                </li>
                                <li id="frozen-cleaned"><a class="popup-page-url" parent-id="frozen-cleaned"
                                        href="../../pages/soft-shelled-mudcrabs/pages/frozen-cleaned.html #content">Frozen -
                                        Cleaned</a></li>
                                <li id="alive"><a class="popup-page-url" parent-id="alive"
                                        href="../../pages/soft-shelled-mudcrabs/pages/alive.html #content">Alive</a></li>
                                <li id="frozen-deepfried"><a class="popup-page-url" parent-id="frozen-deepfried"
                                        href="../../pages/soft-shelled-mudcrabs/pages/frozen-deepfried.html #content">Frozen - Deep
                                        Fried</a></li>
                            </ul>
                        </li>
        ...
        <footer class="full-width z-index-5 relative">
            <svg class="absolute" style="margin-bottom: -10px;" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 761.705 463.652">
                <g style="filter: drop-shadow( 6px 0px 6px rgba(0, 0, 0, 0.8));" id="Group_41"
                    transform="translate(-107 -821)">
                    <g transform="matrix(1, 0, 0, 1, 107, 821)">

                        <radialGradient id="Rectangle_6-2_00000118393049395272186980000003601199239602735242_"
                            cx="131.1084" cy="482.7901" r="0.3883"
                            gradientTransform="matrix(499.1503 -43.0117 -43.0117 -499.1503 -44478.5859 246751.6562)"
                            gradientUnits="userSpaceOnUse">
                            <stop offset="0" style="stop-color:#FF8A34" />
                            <stop offset="1" style="stop-color:#E00000" />
                        </radialGradient>
                        <path id="Rectangle_6-2"
                            style="fill:url(#Rectangle_6-2_00000118393049395272186980000003601199239602735242_);"
                            d="
                ...
                <g style="filter: drop-shadow( 6px 0px 6px rgba(0, 0, 0, 0.8));"
                    id="Group_41_00000159461837734112345100000006418876321107595199_" transform="translate(-107 -821)">
                    <g transform="matrix(1, 0, 0, 1, 107, 821)">

                        <radialGradient id="Rectangle_6-2_00000133508265552570723280000009298788813370790018_"
                            cx="131.7027" cy="482.6174" r="0.2901"
                            gradientTransform="matrix(499.1503 -43.0117 -43.0117 -499.1503 -44478.5859 246751.6562)"
                            gradientUnits="userSpaceOnUse">
                            <stop offset="0" style="stop-color:#FF8A34" />
                            <stop offset="1" style="stop-color:#E00000" />
                        ...
                        <path id="Rectangle_6-2_00000102523483417539575970000010441552123867476642_"
                            style="fill:url(#Rectangle_6-2_00000133508265552570723280000009298788813370790018_);"
                            d="
                    ...
                    <g>
                        ...
                        <clipPath id="Rectangle_7_00000071535616020478365760000010045756066559111054_">
                            <use xlink:href="#Rectangle_7_00000118374291188098860910000009259735561836766373_"
                ...
                <g style="filter: drop-shadow( 6px 0px 6px rgba(0, 0, 0, 0.8));"
                    id="Group_41_00000003078696164919490630000001320425455692212113_" transform="translate(-107 -821)">
                    <g transform="matrix(1, 0, 0, 1, 107, 821)">
                        <radialGradient id="Rectangle_6-2_00000108274577833090856370000008530305212779170969_"
                            cx="131.3732" cy="482.4697" r="0.372"
                            gradientTransform="matrix(499.1503 -43.0117 -43.0117 -499.1503 -44478.5859 246751.6562)"
                            gradientUnits="userSpaceOnUse">
                            <stop offset="0" style="stop-color:#FF8A34" />
                            <stop offset="1" style="stop-color:#E00000" />
                        </radialGradient>
                        <path id="Rectangle_6-2_00000054265630195933872920000000224317566555944578_"
                            style="fill:url(#Rectangle_6-2_00000108274577833090856370000008530305212779170969_);"
                            d="
                    ...
                    <g>
                        <defs>
                            <path id="Rectangle_7_00000052821040910783348520000017259514160633741959_"
                                d="M451.319,993.002L451.319,993.002
                        ...
                        <clipPath id="Rectangle_7_00000011750910233994347730000001836264302129693076_">
                            <use xlink:href="#Rectangle_7_00000052821040910783348520000017259514160633741959_"
                                style="overflow:visible;" />
                        </clipPath>
            ...
            <svg style="margin-bottom: -10px;" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 761.705 463.652">
                <defs>
                    <linearGradient id="linear-gradient" y1="0.5" x2="1" y2="0.5" gradientUnits="objectBoundingBox">
                    ...
                    <linearGradient id="linear-gradient-2" x1="0.054" y1="0.21" x2="0.849" y2="0.898"
                        gradientUnits="objectBoundingBox">
