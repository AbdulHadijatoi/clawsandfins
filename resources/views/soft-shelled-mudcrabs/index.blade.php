...
@section('content')
        ...
        <div class="content-wrapper">
                ...
                <div class="content full-width">
                    <div class="full-width align-in-center pb-50">
                        <div class="_75-width flex-column z-index-1 justify-center md_90-width md_align-center">
                            ...
                            <div class="full-width justify-between align-center sm_flex-column sm_justify-center mb-10">
                ...
                <div class="content">
                    <div class="full-width align-in-center pb-40 mt-50">
                        <div class="_75-width flex-column z-index-1 justify-center sm_90-width sm_align-center mt-20 sm_mt-10 pb-100">
                            ...
                            <p class="para text-white sm_font-size-11 sm_text-center mb-15">
            ...
            <section class="section" data-clip-id="3" style="background-image: url({{asset('bg/pattern_bg2.jpg')}});">
                <div class="content">
                    <div class="full-width align-in-center pt-0 pb-60">
                        <div class="_75-width flex-column z-index-1 justify-center sm_90-width sm_align-center sm_mt_0">
                            ...
                            <div class="full-width relative mt-50">
                                <video poster="{{asset('videos/thumb/SSC for Distributors-1.png')}}" class="full-width">
                                    <source src="{{asset('videos/SSC for Distributors-1.mp4')}}" type="video/mp4">
                                    Your browser does not support the video tag.
                                </video>
                                <div class="play-button"><span class="fa fa-play"></span></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="section" data-clip-id="7" style="background-image: url({{asset('bg/Grey_Background_3.png')}});">
                ...
                <img img-arc="6" class="img-arc" src="{{asset('arcs/arc_13.svg')}}" />
            </section>
